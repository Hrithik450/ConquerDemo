...
export async function createContractProductAttributeValueRestriction(
  ...
  try {
    ...
    const validatedData = contractProductAttributeValueRestrictionSchema.parse(data);
    const restriction = await ContractProductAttributeValueRestrictionsModel.createContractProductAttributeValueRestriction(
      validatedData
    );
...
export async function getContractProductAttributeValueRestriction(
  ...
  try {
    ...
    const restriction = await ContractProductAttributeValueRestrictionsModel.getContractProductAttributeValueRestriction(
      contractId,
      productId,
      attributeId,
      attributeValueId
...
export async function getRestrictionsByContractId(
  ...
  try {
    ...
    const restrictions = await ContractProductAttributeValueRestrictionsModel.getRestrictionsByContractId(
      contractId
    );
...
export async function getRestrictionsByProductId(
  ...
  try {
    ...
    const restrictions = await ContractProductAttributeValueRestrictionsModel.getRestrictionsByProductId(
      productId
    );
...
export async function getRestrictionsByAttributeId(
  ...
  try {
    ...
    const restrictions = await ContractProductAttributeValueRestrictionsModel.getRestrictionsByAttributeId(
      attributeId
    );
...
export async function updateContractProductAttributeValueRestriction(
  ...
  try {
    ...
    const updatedRestriction = await ContractProductAttributeValueRestrictionsModel.updateContractProductAttributeValueRestriction(
      contractId,
      productId,
      attributeId,
      attributeValueId,
...
export async function deleteContractProductAttributeValueRestriction(
  ...
  try {
    ...
    const success = await ContractProductAttributeValueRestrictionsModel.deleteContractProductAttributeValueRestriction(
      contractId,
      productId,
      attributeId,
      attributeValueId
...
export async function listContractProductAttributeValueRestrictions(): Promise<ContractProductAttributeValueRestrictionsResponse> {
  try {
    ...
    const restrictions = await ContractProductAttributeValueRestrictionsModel.listContractProductAttributeValueRestrictions();
    return { success: true, data: restrictions };
  } catch (error) {
