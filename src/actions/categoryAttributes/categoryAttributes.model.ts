...
import type {
  ...
  CategoryAttribute,
} from "./categoryAttributes.types";

export class CategoryAttributesModel {
  static async createCategoryAttribute(
  ...
  static async getCategoryAttribute(
    categoryId: string,
    attributeId: string
  ...
  static async getAttributesByCategoryId(
    categoryId: string
  ): Promise<CategoryAttribute[]> {
    return await db
      .select()
  ...
  static async getCategoriesByAttributeId(
    attributeId: string
  ): Promise<CategoryAttribute[]> {
    return await db
      .select()
  ...
  static async deleteCategoryAttribute(
    categoryId: string,
    attributeId: string
  ): Promise<boolean> {
