...
const Hero = () => {
  return (
    <section className="bg-[#F5F5F7] py-14 md:py-16">
      <div className="mx-auto max-sm:mx-5 max-lg:mx-10 lg:max-w-5/6 flex justify-between items-center max-md:pb-4 max-md:flex-col max-md:items-start">
